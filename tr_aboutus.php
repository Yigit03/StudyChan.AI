...
<html lang="tr">
  <head>
    ...
    <title> Studychan.AI | About </title>
    <link rel="stylesheet" type="text/css" href="/sat_4/Style_Files/style4.css">
  </head>
    <body>
          ...
          <div class="_157dc3d3">
            <nav id="kqqdzrxru9" class="_e45b5504 um-nav-wrapper um-classic">
              ...
              <div class="um-nav-buttons">
                ...
                <a href="tr_aboutus.php" id="ssqeillje58" class="btn primary">
                  <svg xmlns="http://www.w3.org/2000/svg" class="um-icon _488bdcb8" fill="currentColor" width="24" height="24" viewBox="0 0 24 24">
            ...
            <div id="kqqdzrxru9-drawer" class="_e45b5504 um-nav-drawer um-hidden">
              ...
              <div class="um-drawer-buttons">
                ...
                <a href="tr_aboutus.php" id="d_ssqeillje58" class="btn primary">
                  <svg xmlns="http://www.w3.org/2000/svg" class="um-icon _488bdcb8" fill="currentColor" width="24" height="24" viewBox="0 0 24 24">
                    <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"></path>
                  </svg>
                  <span>Hakkımızda</span>
            ...
            <div class="_515a6cb2">
              <a href="tr_home.php" class="_f2f2ae5f">
                ...
                <header class="_2abb7848">
                  <h1 class="_061c53c9">
                    <strong> <span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg"> Hoşgeldin !</span></strong>
                            <span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg"> Bizi tanımak ister misin?</span>           
                  </h1><br><br>
                  <p class="_6685fd13">
                    <span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg"> Bizi tanımak için aşağıda bulunan geliştirici ekibimizin kartlarında "Detaylı Gösterim" butonuna basabilirsiniz.</span><br><br>
                    <span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg"> Bizlere ulaşmak için ise aşağıda bulunan formu doldurabilir veya kendiniz "studychanai@iletisim.com" adresine mail atabilirsiniz.</span>
                  </p>
                </header>
            </div>
          </div>
          ...
          <div class="_a5659a75">
            ...
            <div class="_b0df1e00">
                    <div id="ata1" class="_Atadiv active">
                        ...
                        <span class="_00f8cf11">23 Yaşında, kariyerine oyun geliştirme üzerine devam etmeyi planlıyor.</span><br><br>
                        <button id="toggleButtonAta2" class="_f8f654da btn"><span>Gözatt</span></button>
                    </div>

                    <div id="ata2" class="_Atadiv">
                        <img src="./studychanaiv2_files/sp35pj8qjvf1lk8q.png" class="_241c7c24" alt="Ata.png">
                        <span class="_79756493">Ata Arda ALPAT</span>
                        <span class="_d111c28e">Fullstack Developer</span>
                        <div class="_fb7a000c">
                        ...
                        <span class="_00f8cf11">Stok Takip projesini geliştirdi.</span><br>
                        <span class="_00f8cf11">Online Chat projesini geliştirdi.</span><br>
                        <span class="_00f8cf11">MasterCord projesini geliştirdi.</span><br><br>
                        <button id="toggleButtonAta1" class="_f8f654da btn"><span>Gözaat</span></button>
                    </div>

                    <div class="AtaAciklama" id="surekli">
                        <h2 class="_842363b1"><span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg"><underline>Beni Tanımak İster Misin?</underline></span></h2>
                        <p class="_11216ae2">
                            <span class="um-gradient-text" style="--from:#3B4371;--to:#F3904F;--angle:45deg">
                            Merhabalar, adım Ata Arda Alpat. 23 yaşındayım ve Ege Üniversitesi öğrencisiyim. Daha önce büyük çaplı projelerde yer aldım ve yazılım konusunda kendimi geliştirmeyi düşünüyorum.
                            </span>
                        </p>
                        <p class="_11216ae2">
                            <span class="um-gradient-text" style="--from:#3B4371;--to:#F3904F;--angle:45deg">
                            Daha öncesinde yaptığım en büyük proje PHP kullanarak anlık sohbet odası geliştirmekti. Burada Socket Server olarak saf php kullandım ve web socketi ise sadece javascript ile yazdım. Backend program geliştirme bilgilerime güveniyorum.
                            </span>
                        </p>
                    </div>

                    <div class="AtaAciklama" id="gizli" style="display: None;">
                        <h2 class="_842363b1"><span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg"><underline>Hakkımda daha fazlası ;</underline></span></h2>
                        <p class="_11216ae2">
                            <span class="um-gradient-text" style="--from:#3B4371;--to:#F3904F;--angle:45deg">
                            Merhabalar, adım Ata Arda Alpat. 23 yaşındayım ve Ege Üniversitesi öğrencisiyim. Daha önce büyük çaplı projelerde yer aldım ve yazılım konusunda kendimi geliştirmeyi düşünüyorum.
                            </span>
                        ...
                        <p class="_11216ae2">
                            <span class="um-gradient-text" style="--from:#3B4371;--to:#F3904F;--angle:45deg">
                            Kişisel ilgi alanlarım yazılım dışında bilgisayar oyunları oynamak, spor yapmak, fotoğraf çekmek ve meteverse ile ilgilenmek. Meteverse deme sebebim çalıştığım yer olan Mytek Reality sadece VR teknoloji üzerine uzmanlaşmış bir firma ve bu firmada kendimi 2024 yılından ziyade sanki geleceğe gitmişim de 2050 yılında çalışıyormuşum gibi hissediyorum.
                            </span>
                        </p>
                    </div>

                    
                    <div id="samet1" class="_Sametdiv active">
                     <img src="./studychanaiv2_files/x5z0kqg1no9ed4p4.jpg" class="_241c7c24" alt="samet007.jpg">
                        <span class="_79756493">Samet Yavuz</span>
                        <span class="_d111c28e">AR-GE (API) Manager</span>
                        <div class="_fb7a000c">
                            <a href="https://steamcommunity.com/id/RainyBlood/" class="_3c7b44fe">
                                <img class="um-icon _a92ee5d6" src="./studychanaiv2_files/4148cjs9r6myrozh.svg" alt="steam.svg" style="position:relative;width:24px;height:24px;display:block;object-fit:contain">
                            </a>
                        ...
                        <span class="_00f8cf11">23 Yaşında, kariyerine oyun geliştirme üzerine devam etmeyi planlıyor.</span><br>
                        <button id="toggleButtonSamet2" class="_f8f654da btn"><span>Gözatt</span></button>
                    </div>

                    <div id="samet2" class="_Sametdiv">
                        <img src="./studychanaiv2_files/x5z0kqg1no9ed4p4.jpg" class="_241c7c24" alt="samet007.jpg">
                        <span class="_79756493">Samet Yavuz</span>
                        <span class="_d111c28e">AR-GE (API) Manager</span>
                        <div class="_fb7a000c">
                        ...
                        <span class="_00f8cf11">20 Yaşında, kariyerine AR-GE üzerine devam etmeyi planlıyor.</span><br>
                        <button id="toggleButtonSamet1" class="_f8f654da btn"><span>Gözaat</span></button>
                    </div>

                    <div class="SametAciklama" id="surekli2">
                        <h2 class="_842363b1"><span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg"><underline>Beni Tanımak İster Misin?</underline></span></h2>
                        <p class="_11216ae2">
                            <span class="um-gradient-text" style="--from:#3B4371;--to:#F3904F;--angle:45deg">
                            Merhaba! Ben Samet, Ege Üniversitesi'nde bilgisayar programcılığı, Anadolu ve İstanbul Üniversitesi'nde web tasarımı ve kodlama bölümlerinde eğitim alıyorum. Elektrik elektronik tamiri konusunda 9 yıllık deneyime sahibim ve kendi atölyemde çalışmaktayım, özellikle bilgisayar ve elektronik cihazlar üzerinde tamiratlar yapıyorum.                            </span>
                        </p>
                        <p class="_11216ae2">
                            <span class="um-gradient-text" style="--from:#3B4371;--to:#F3904F;--angle:45deg">
                            Çalışmayı seven, teknolojiye ilgi duyan ve kendi atölyesinde profesyonel hizmetler sunan biriyim. Bilgisayar programcılığı ve web tasarımı konularında aldığım eğitimlerle kendimi sürekli geliştirmekteyim. Hedefim, bilgi ve becerilerimi birleştirerek alanımda başarılı bir kariyere sahip olmak ve projelerde etkili bir şekilde yer almak.                            </span>
                        </p>
                    </div>

                    <div class="SametAciklama" id="gizli2" style="display: None;">
                        <h2 class="_842363b1"><span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg"><underline>Hakkımda daha fazlası ;</underline></span></h2>
                        <p class="_11216ae2">
                            <span class="um-gradient-text" style="--from:#3B4371;--to:#F3904F;--angle:45deg">
                            Merhaba! Ben Samet, Ege Üniversitesi'nde bilgisayar programcılığı, Anadolu ve İstanbul Üniversitesi'nde web tasarımı ve kodlama bölümlerinde eğitim alıyorum. Elektrik elektronik tamiri konusunda 9 yıllık deneyime sahibim ve kendi atölyemde çalışmaktayım, özellikle bilgisayar ve elektronik cihazlar üzerinde tamiratlar yapıyorum.                            </span>
                    ...
                    <div id="yigit1" class="_Yigitdiv active">
                        ...
                        <span class="_00f8cf11">21 Yaşında, kariyerine oyun geliştirme üzerine devam etmeyi planlıyor.</span><br>
                        <button id="toggleButtonYigit2" class="_f8f654da btn"><span>Gözatt</span></button>
                    </div>

                    <div id="yigit2" class="_Yigitdiv">
                        <img src="./studychanaiv2_files/qov16vdled4jtvti.jpg" class="_241c7c24" alt="yigitinyamukyumuk.jpg">
                        <span class="_79756493">Yiğit ESER</span>
                        <span class="_d111c28e">Backend Developer</span>
                        <div class="_fb7a000c">
                        ...
                        <span class="_00f8cf11">21 Yaşında, kariyerine Backend ve Veri Yapıları üzerine devam etmeyi planlıyor.</span><br>
                        <button id="toggleButtonYigit1" class="_f8f654da btn"><span>Gözaat</span></button>
                    </div>

                    <div class="YigitAciklama" id="surekli3">
                        <h2 class="_842363b1"><span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg"><underline>Beni Tanımak İster Misin?</underline></span></h2>
                        <p class="_11216ae2">
                            <span class="um-gradient-text" style="--from:#3B4371;--to:#F3904F;--angle:45deg">
                            Ege Üniversitesi Bilgisayar Programcılığı 2. sınıf öğrencisiyim. Yazılım ve teknoloji alanına olan merakım sebebiyle yeni bilgiler öğrenmeye ve kendimi geliştirmeye çalışıyorum. Kod yazmak, algoritmaları çözmek ve yeni teknolojilere dalmak benim için bir tutkudur. Karmaşık sorunları çözmekten keyif alıyorum. Kodlama dünyasında kendimi ifade etmek ve projeler üretmek benim için büyük bir heyecan kaynağı.                            </span>
                        </p>
                        <p class="_11216ae2">
                            <span class="um-gradient-text" style="--from:#3B4371;--to:#F3904F;--angle:45deg">
                            Ege Üniversitesi Bilgisayar Programcılığı 2. sınıf öğrencisiyim. Yazılım ve teknoloji alanına olan merakım sebebiyle yeni bilgiler öğrenmeye ve kendimi geliştirmeye çalışıyorum. Kod yazmak, algoritmaları çözmek ve yeni teknolojilere dalmak benim için bir tutkudur. Karmaşık sorunları çözmekten keyif alıyorum. Kodlama dünyasında kendimi ifade etmek ve projeler üretmek benim için büyük bir heyecan kaynağı.                            </span>
                    ...
                    <div class="YigitAciklama" id="gizli3" style="display: None;">
                        <h2 class="_842363b1"><span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg"><underline>Hakkımda daha fazlası ;</underline></span></h2>
                        <p class="_11216ae2">
                            <span class="um-gradient-text" style="--from:#3B4371;--to:#F3904F;--angle:45deg">
                            Ege Üniversitesi Bilgisayar Programcılığı 2. sınıf öğrencisiyim. Yazılım ve teknoloji alanına olan merakım sebebiyle yeni bilgiler öğrenmeye ve kendimi geliştirmeye çalışıyorum. Kod yazmak, algoritmaları çözmek ve yeni teknolojilere dalmak benim için bir tutkudur. Karmaşık sorunları çözmekten keyif alıyorum. Kodlama dünyasında kendimi ifade etmek ve projeler üretmek benim için büyük bir heyecan kaynağı.                            </span>
                ...
                <script>
                    ...
                    document.querySelector('#toggleButtonAta2').addEventListener('click', function() {
                        var sametDiv = document.getElementById('ata1');
                        var ataDiv = document.getElementById('ata2');

                        sametDiv.classList.toggle('active');
                        ataDiv.classList.toggle('active');
                        var surekliDiv = document.getElementById('surekli');
                        var gizliDiv = document.getElementById('gizli');

                        surekliDiv.style.display = 'none';
                        gizliDiv.style.display = 'block';
                    });

                    document.querySelector('#toggleButtonAta1').addEventListener('click', function() {
                        var sametDiv = document.getElementById('ata1');
                        var ataDiv = document.getElementById('ata2');
                        ...
                        surekliDiv.style.display = 'block';
                        gizliDiv.style.display = 'none';
                    });


                    document.querySelector('#toggleButtonSamet2').addEventListener('click', function() {
                        var sametDiv = document.getElementById('samet1');
                        var ataDiv = document.getElementById('samet2');

                        sametDiv.classList.toggle('active');
                        ataDiv.classList.toggle('active');
                        var surekliDiv = document.getElementById('surekli2');
                        var gizliDiv = document.getElementById('gizli2');

                        surekliDiv.style.display = 'none';
                        gizliDiv.style.display = 'block';
                    });

                    document.querySelector('#toggleButtonSamet1').addEventListener('click', function() {
                        var sametDiv = document.getElementById('samet1');
                        var ataDiv = document.getElementById('samet2');
                    ...
                    document.querySelector('#toggleButtonYigit2').addEventListener('click', function() {
                        var sametDiv = document.getElementById('yigit1');
                        var ataDiv = document.getElementById('yigit2');

                        sametDiv.classList.toggle('active');
                        ataDiv.classList.toggle('active');
                        var surekliDiv = document.getElementById('surekli3');
                        var gizliDiv = document.getElementById('gizli3');

                        surekliDiv.style.display = 'none';
                        gizliDiv.style.display = 'block';
                    });

                    document.querySelector('#toggleButtonYigit1').addEventListener('click', function() {
                        var sametDiv = document.getElementById('yigit1');
                        var ataDiv = document.getElementById('yigit2');
    ...
    <div class="screen">
      ...
      <div class="screen-body">
        <div class="screen-body-item left">
          <div class="app-title">
            <span>Studychan.AI</span>
            <span>------------</span>
          </div>
          <div class="app-contact">Vereceğiniz bilgiler, KBKK kanuna göre sitemizde saklanacak ve 3. parti kişilerle veya şirketlerle paylaşılmayacaktır.</div>
        </div>
        <div class="screen-body-item">
          <div class="app-form">
            <form action="/sat_4/Back_End_Files/contact.php" method="post">
              <div class="app-form-group">
                <input type="text" name="username" class="app-form-control" placeholder="Adınızı giriniz." value="">
              </div>
              <div class="app-form-group">
                <input type="mail" name="mail" class="app-form-control" placeholder="Mail Adresinizi giriniz.">
              </div>
              <div class="app-form-group">
                <input type="tel" name="telephone" class="app-form-control" placeholder="Telefon Numaranızı giriniz.">
              </div>
              <div class="app-form-group message">
                <input type="text" name="message" class="app-form-control" placeholder="Mesajınızı yazınız.">
              </div>
