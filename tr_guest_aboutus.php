...
<html lang="tr">
  <head>
    ...
    <title> Studychan.AI | Guest </title>
    ...
    <body>
          ...
          <div class="_157dc3d3">
            <nav id="kqqdzrxru9" class="_e45b5504 um-nav-wrapper um-classic">
              ...
              <div class="um-nav-buttons">
                <a href="tr_guest_home.php" id="qopultom2t" class="_e72e75b2 btn">
                ...
                <a href="login.html" id="p5usdyhrr8n" class="_89517563 btn">
                  <svg xmlns="http://www.w3.org/2000/svg" class="um-icon _488bdcb8" fill="currentColor" width="24" height="24" viewBox="0 0 24 24">
                ...
                <a href="login.html" id="f2t9ofnrkyg" class="_efb43553 btn">
            ...
            <div id="kqqdzrxru9-drawer" class="_e45b5504 um-nav-drawer um-hidden">
              ...
              <div class="um-drawer-buttons">
                <a href="tr_guest_home.php" id="d_qopultom2t" class="btn primary">
                  <svg xmlns="http://www.w3.org/2000/svg" class="um-icon _488bdcb8" fill="currentColor" width="24" height="24" viewBox="0 0 24 24">
                    <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"> </path>
                  </svg>
                  <span>Anasayfa</span>
                </a>
                <a href="login.html" id="d_p5usdyhrr8n" class="_89517563 btn">
                  <svg xmlns="http://www.w3.org/2000/svg" class="um-icon _488bdcb8" fill="currentColor" width="24" height="24" viewBox="0 0 24 24">
                    <path d="M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 4h5v8l-2.5-1.5L6 12V4z"> </path>
                  </svg>
                  <span>Kütüphane</span>
                ...
                <a href="#" id="d_f2t9ofnrkyg" class="_efb43553 btn">
                  <img class="um-icon _488bdcb8" src="./studychanaiv2_files/et6nkzsq7uf3q8zc.svg" alt="users.svg" style="position:relative;width:24px;height:24px;display:block;object-fit:contain">
                  <span>Profil</span>
                  <svg width="1em" viewBox="0 0 15 12" xmlns="http://www.w3.org/2000/svg" class="um-arrow">
                    <path d="M9.6 7H1a1 1 0 1 1 0-2h8.6L7 2.4A1 1 0 0 1 8.4 1l4.3 4.2c.2.3.3.5.3.8 0 .3-.1.5-.3.7L8.4 11A1 1 0 1 1 7 9.5L9.6 7z" fill="currentColor"></path>
      ...
      <section class="EgeYazisi">
        <div class="wr">
          <div class="_4d01d81a">
            <div class="_515a6cb2">
              <a href="tr_guest_home.php" class="_f2f2ae5f">
          ...
          <div class="_a5659a75">
            ...
            <div class="_b0df1e00">
                    ...
                    <div id="ata2" class="_Atadiv">
                        ...
                        <span class="_00f8cf11">X projesini geliştirdi.</span><br>
                        <span class="_00f8cf11">Y projesini geliştirdi.</span><br>
                        <span class="_00f8cf11">Z projesini geliştirdi.</span><br><br>
                    ...
                    <div class="AtaAciklama" id="surekli">
                        ...
                        <p class="_11216ae2">
                            ...
                            KENDİM HAKKINDA ZIRVALADIĞIM BÖLÜM KENDİM HAKKINDA ZIRVALADIĞIM BÖLÜM KENDİM HAKKINDA ZIRVALADIĞIM BÖLÜM KENDİM HAKKINDA ZIRVALADIĞIM BÖLÜM KENDİM HAKKINDA ZIRVALADIĞIM BÖLÜM KENDİM HAKKINDA ZIRVALADIĞIM BÖLÜM KENDİM HAKKINDA ZIRVALADIĞIM BÖLÜM KENDİM HAKKINDA ZIRVALADIĞIM BÖLÜM KENDİM HAKKINDA ZIRVALADIĞIM BÖLÜM KENDİM HAKKINDA 
                            </span>
                        </p>
                        <p class="_11216ae2">
                            <span class="um-gradient-text" style="--from:#3B4371;--to:#F3904F;--angle:45deg">
                            KENDİM HAKKINDA ZIRVALADIĞIM BÖLÜM KENDİM HAKKINDA ZIRVALADIĞIM BÖLÜM KENDİM HAKKINDA ZIRVALADIĞIM BÖLÜM KENDİM HAKKINDA
                            </span>
                        </p>
                    </div>
        ...
        <div class="screen-body-item">
          <div class="app-form">
            <div class="app-form-group">
              <input class="app-form-control" placeholder="Adınızı giriniz." value="">
            </div>
            <div class="app-form-group">
              <input class="app-form-control" placeholder="Mail Adresinizi giriniz.">
            </div>
            <div class="app-form-group">
              <input class="app-form-control" placeholder="Telefon Numaranızı giriniz.">
            </div>
            <div class="app-form-group message">
              <input class="app-form-control" placeholder="Mesajınızı yazınız.">
            </div>
