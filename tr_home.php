...
<html lang="tr">
  <head>
    ...
    <title> Studychan.AI | Anasayfa </title>
    <link rel="stylesheet" type="text/css" href="/sat_4/Style_Files/style.css">
    ...
    <body>
          ...
          <div class="_157dc3d3">
            <nav id="kqqdzrxru9" class="_e45b5504 um-nav-wrapper um-classic">
              ...
              <div class="um-nav-buttons">
                <a href="tr_home.php" id="qopultom2t" class="btn primary">
            ...
            <div id="kqqdzrxru9-drawer" class="_e45b5504 um-nav-drawer um-hidden">
              ...
              <div class="um-drawer-buttons">
                <a href="tr_home.php" id="d_qopultom2t" class="btn primary">
                  <svg xmlns="http://www.w3.org/2000/svg" class="um-icon _488bdcb8" fill="currentColor" width="24" height="24" viewBox="0 0 24 24">
                    <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"> </path>
                  </svg>
                  <span>Anasayfa</span>
      ...
      <section class="_124b3270">
        <div class="wr">
          <div class="_4d01d81a">
            <div class="_515a6cb2">
              <a href="##" class="_f2f2ae5f">
                <span> 2024 Ege Üniversitesi Bilgisayar Programcılığı</span>—<span>Yeni Nesil PDF Okuyucu</span>
              </a>
                <header class="_2abb7848">
                  <h1 class="_061c53c9">
                    <strong> <span class="um-gradient-text" style="--from:#173e72;--to:#723657;--angle:45deg"> Yeni nesil PDF okuyucu !</span></strong>
                          <br><br>              
                  </h1>
                  <p class="_6685fd13">
                    <span class="um-gradient-text" style="--from:#ffffff;--to:#ffffff;--angle:45deg"> Sürekli PDF okumaktan ve not çıkartmaktan yoruldunuz mu? Studychan.ai tam sizlere göre.</span><br><br>
                    <span class="um-gradient-text" style="--from:#ffffff;--to:#ffffff;--angle:45deg"> Sizin için birden fazla PDF inceledik ve incelemeye devam ediyoruz. </span><br><br>
                    <span class="um-gradient-text" style="--from:#ffffff;--to:#ffffff;--angle:45deg"> Gelin sizin de belgelerinizi inceleyelim ve sizin için not çıkarıp sorular soralım. </span>
                  </p>
                </header>
                <div class="_42a62395">
                  <button id="1miscgssp14" class="_11c5c778 btn">
                    <svg xmlns="http://www.w3.org/2000/svg" class="um-icon _488bdcb8" fill="currentColor" width="24" height="24" viewBox="0 0 24 24">
                  ...
                  <div id="uploadForm">
                    <form id="fileUploadForm" method="post"  enctype="multipart/form-data" action="tr_chatdialog.php">
                      ...
                      <button type="button" id="startChat" class="upload _11c5c778 btn primary">
                        ...
                        <span>Öğrenmeye Başla -> <i class="fa-solid fa-arrow-right-long"></i></span>
                      </button>
...
async function extractText(url) {
        try {
            ...
            <div class="_aa933e59">
              <div class="_ef21e6e5">
                <div class="_8c3713bc">
                  <img src="./studychanaiv2_files/u41t98ohgas8e4j4.svg" class="_1d0eed2d" alt="app-2.svg">
                </div>
              </div>
              <div class="_b8049c78">
                <div class="_d40dd8d2">
                  <img src="./studychanaiv2_files/u41t98ohgas8e4j4.svg" class="_53db9b97" alt="app-2.svg">
                </div>
              </div>
              <div class="_7017e391">
                <div class="_8a65e437">
                  <img src="./studychanaiv2_files/u41t98ohgas8e4j4.svg" class="_24bc09ef" alt="app-2.svg">
                </div>
              </div>
            </div>
          </div>
...
// PDF puanlarının ortalamasını almak için bir SQL sorgusu oluşturuyorum.
$sql_point = "SELECT AVG(documan_point) FROM library";
// mysqli_query fonksiyonuyla SQL sorgusunu çalıştırıyorum ve sonucu $result_point değişkenine atıyorum.
$result_point = mysqli_query($conn, $sql_point);
// mysqli_fetch_assoc fonksiyonuyla sorgu sonucunu bir dizi olarak alıyorum ve 'AVG(documan_point)' anahtarının değerini $point değişkenine atıyorum.
$point = mysqli_fetch_assoc($result_point)['AVG(documan_point)'];
// $point değişkenindeki değeri, virgülden sonra iki basamak olacak şekilde biçimlendiriyorum ve (double) ile çift duyarlıklı hale getiriyorum.
$point = (double) number_format($point, 2, '.', '');

//<!-------------------------------------soru sayısı----------------------------------------->

// 'chat' tablosundaki 'questions_amount' sütununun toplamını almak için bir SQL sorgusu oluşturuyorum.
$sql_question = "SELECT SUM(question_amount) FROM users";
// mysqli_query fonksiyonuyla SQL sorgusunu çalıştırıyorum ve sonucu $result_question değişkenine atıyorum.
$result_question = mysqli_query($conn, $sql_question);
// mysqli_fetch_assoc fonksiyonuyla sorgu sonucunu bir dizi olarak alıyorum ve 'SUM(questions_amount)' anahtarının değerini $question değişkenine atıyorum.
$question = mysqli_fetch_assoc($result_question)['SUM(question_amount)'];

//<!------------------------toplam kullanıcı ve doküman sayısı------------------------------->

// 'total' tablosundaki tüm verileri seçmek için bir SQL sorgusu oluşturuyorum.
        ...
        <div class="wr">
          <div class="_621e8364">
            <header class="_00a46be6">
              <h2 class="_95ba41af">
                <span class="um-gradient-text " style="--from:#3a6186;--to:#89253e;--angle:45deg"><?php echo $_date; ?></span><br><br>
              </h2>
              <p class="_ed6b8b81">
                <span class="um-gradient-text" style="--from:#ffffff;--to:#ffffff;--angle:45deg; font-size:25px;">Ne ölçüde düzenli olarak ilgileniyoruz? Gerçekten onun yeteneklerinden en iyi şekilde yararlanıyor myuz?</span>
              </p>
            </header>
            <div class="_764d0fac">
              <div class="_facf5882">
                ...
                <span class="_56302183"><br> 
                  ...
                  <strong><em><span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg">Taratımı Yaptık</span></em></strong>
                </span>
              </div>
              <div class="_facf5882">
                <div class="_cfada5cc">
                  -<span data-value="<?php echo $_users ; ?>" class="countup"></span>
                -</div>
                <span class="_56302183"><br>
                  <strong>Kullanıcı</strong><br>
                  <strong><em><span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg">Sitemize Üye Oldu</span></em></strong>
                </span>
              </div>
              <div class="_facf5882">
                <div class="_cfada5cc">
                  -<span data-value="23" class="countup"></span>
                -</div>
                <span class="_56302183"><br>
                  <strong>Soru</strong><br>
                  <span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg">Üretildi ve Çözüldü</span>
                </span>
              </div>
              <div class="_facf5882">
                <div class="_cfada5cc">
                  <span data-value="<?php echo $point ;?>" class="countup"></span>/10
                </div>
                  <span class="_56302183"><br>Puan<br><strong><em><span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg">Değerlendirildi</span></em></strong></span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="_ab6a7701">
        <div class="wr">
          <header class="_dc7e24f4">
            <h2 class="_05a02d8e">
              <span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg">Kütüphanemiz</span>
            </h2>
            <p class="_f795fb6e">
              <span class="um-gradient-text" style="--from:#ffffff;--to:#ffffff;--angle:45deg"><br>Moderatörlerimiz tarafından seçilen en başarılı PDF'lerimiz.</span><br><br>
              <span class="um-gradient-text" style="--from:#ffffff;--to:#ffffff;--angle:45deg">Siz de kendi PDF'lerinizi bizlere ileterek kütüphanemizde yer almalarını sağlayabilirsiniz. Unutmayın, her bir döküman detaylıca incelenecektir!</span><br><br><br>
            </p>
          </header>
          <div class="_daa84547">
<?php 
$sql_library = "SELECT * FROM library
              ";

$result_library = mysqli_query($conn, $sql_library); 
if($result_library->num_rows > 0)
{
  while($lib = $result_library->fetch_assoc())
  {

    echo  '<div class="_924d9844 homelibrary">';
    ...
    echo  '</svg>';
    echo  "<h3 class='_58b23f43'><span style='color:rgb(0, 0, 0)'>".$lib['documan_name']."</span></h3>";  
    echo  '<span class="_34b9f5ea">';
    echo    '<span style="color:rgb(255, 255, 255)">';
    echo     '  <br>';
    echo     "<b> -&gt; ".$lib['documan_name']."<br></b>";
    echo     "<b> -&gt; ".$lib['documan_point']."/10 <br></b>";
    echo     " -&gt; ".$lib['username']."<br>";
    echo    '</span>';
    echo  '</span>';
    echo '</div>';
  }
...
?>    
      ...
      <section class="_1accfbb1">
        <div class="wr">
          <div class="_a5659a75">
            <header class="_5af739d7">
              <img class="um-icon _41dcc11b" src="./studychanaiv2_files/uhu1umh8ee65gu25(1).png" alt="Untitled design.png" style="position:relative;width:24px;height:24px;display:block;object-fit:contain">
              <h2 class="_842363b1"><span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg">Geliştirici Ekibimiz</span><br><br></h2>
              <p class="_11216ae2"><span class="um-gradient-text" style="--from:#3B4371;--to:#F3904F;--angle:45deg">Biz kimiz ve neler başarmak istiyoruz ?</span></p>
            </header>
            <div class="_b0df1e00">
              <div class="_5812e4ce">
                <img src="./studychanaiv2_files/sp35pj8qjvf1lk8q.png" class="_241c7c24" alt="Ata.png">
                  <span class="_79756493">Ata Arda ALPAT</span>
                  <span class="_d111c28e">Frontend Developer</span>
                    <div class="_fb7a000c">
                      <a href="https://steamcommunity.com/id/RainyBlood/" class="_3c7b44fe">
                        <img class="um-icon _a92ee5d6" src="./studychanaiv2_files/4148cjs9r6myrozh.svg" alt="steam.svg" style="position:relative;width:24px;height:24px;display:block;object-fit:contain">
                      </a>
                      <a href="https://twitter.com/" class="_3c7b44fe">
                        <img class="um-icon _a92ee5d6" src="./studychanaiv2_files/48bwy8irdo51jorg.svg" alt="instagram.svg" style="position:relative;width:24px;height:24px;display:block;object-fit:contain">
                      </a>
                      <a href="#" class="_3c7b44fe">
                        <img class="um-icon _a92ee5d6" src="./studychanaiv2_files/rw0u4e0cjtr65cec.svg" alt="discord.svg" style="position:relative;width:24px;height:24px;display:block;object-fit:contain">
                      </a>
                    </div>
                  <span class="_00f8cf11">23 Yaşında, kariyerine oyun geliştirme üzerine devam etmeyi planlıyor.</span>
              </div>
              <div class="_5812e4ce">
                <img src="./studychanaiv2_files/qov16vdled4jtvti.jpg" class="_241c7c24" alt="yigitinyamukyumuk.jpg">
                  <span class="_79756493">Yiğit ESER</span>
                  <span class="_d111c28e">Backend Developer</span>
                  <div class="_fb7a000c">
                    <a href="https://www.linkedin.com/" class="_3c7b44fe">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="24" height="24" class="um-icon _a92ee5d6">
                    ...
                    <a href="https://twitter.com/" class="_3c7b44fe">
                      <img class="um-icon _a92ee5d6" src="./studychanaiv2_files/25lso0pcpl5o1wi8.svg" alt="tiktok.svg" style="position:relative;width:24px;height:24px;display:block;object-fit:contain">
                    </a>
                    <a href="#" class="_3c7b44fe">
                      <img class="um-icon _a92ee5d6" src="./studychanaiv2_files/dt7hqx6dybw0rtvp.svg" alt="pinterest.svg" style="position:relative;width:24px;height:24px;display:block;object-fit:contain">
                    </a>
                  </div>
                  <span class="_00f8cf11">21 Yaşında Digitus da veri tabanı analizcisi.</span>
              </div>
              <div class="_5812e4ce">
                <img src="./studychanaiv2_files/x5z0kqg1no9ed4p4.jpg" class="_241c7c24" alt="samet007.jpg">
                  <span class="_79756493">Samet YAVUZ</span>
                  <span class="_d111c28e">AI / API Developer</span>
                  <div class="_fb7a000c">
                    <a href="https://www.linkedin.com/" class="_3c7b44fe">
                      <img class="um-icon _a92ee5d6" src="./studychanaiv2_files/rw0u4e0cjtr65cec.svg" alt="discord.svg" style="position:relative;width:24px;height:24px;display:block;object-fit:contain">
                    </a>
                    <a href="https://twitter.com/" class="_3c7b44fe">
                      <img class="um-icon _a92ee5d6" src="./studychanaiv2_files/e79xauo8bc1z0drv.svg" alt="reddit.svg" style="position:relative;width:24px;height:24px;display:block;object-fit:contain">
                    </a>
                    <a href="#" class="_3c7b44fe">
                      <img class="um-icon _a92ee5d6" src="./studychanaiv2_files/zffjp9pdafpj7nzs.svg" alt="xtwitter.svg" style="position:relative;width:24px;height:24px;display:block;object-fit:contain">
                    </a>
                  </div>
                  <span class="_00f8cf11">20 Yaşında Ege Üniversitesi Bilgisayar Programcılığı bölümünde öğrenci.</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="_a467cf14">
            <div class="umso-accordion _c133ec94">
              ...
              <div class="_ad24ed1f accordion-item">
                ...
                <div class="_5d78a69c accordion-content">Studychan. AI yapay zekamıza erişim sağlayabilirsiniz.</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer class="_c4b89fde">
        <div class="wr">
          <div class="_bea1daea">
            <div class="_240f2910">
              <span class="_c0e4633f">© 2023 StudyChan. AI Company</span>
            ...
            <ul class="_d1a0a8ea">
              <li class="_0fc50e27">
                  <h4 class="_31f6b92b">Projelerimiz</h4>
                  <ul class="_91687afc">
                    <li class="_e0485177"><a href="#" class="_c288f4a7"> Stok Takip </a></li>
                    <li class="_e0485177"><a href="#" class="_c288f4a7">Online Chat App</a></li>
                    <li class="_e0485177"><a href="#" class="_c288f4a7">Görüntü İşleme</a></li>
                    <li class="_e0485177"><a href="#" class="_c288f4a7">AI Programming</a></li>
                  </ul>
              </li>
              <li class="_0fc50e27">
                  <h4 class="_31f6b92b">Şubelerimiz</h4>
                  <ul class="_91687afc">
                    <li class="_e0485177"><a href="#" class="_c288f4a7">İzmir</a></li>
                    <li class="_e0485177"><a href="#" class="_c288f4a7">Balıkesir</a></li>
                    <li class="_e0485177"><a href="#" class="_c288f4a7">İstanbul</a></li>
                    <li class="_e0485177"><a href="#" class="_c288f4a7">Ankara</a></li>
                  </ul>
              </li>
              <li class="_0fc50e27">
                  <h4 class="_31f6b92b">Referans</h4>
                  <ul class="_91687afc">
                    <li class="_e0485177"><a href="#" class="_c288f4a7"> Ege Üniversitesi </a></li>
                    <li class="_e0485177"><a href="#" class="_c288f4a7">Gazeteci Çetin Altan M.T.A.L</a></li>
                    <li class="_e0485177"><a href="#" class="_c288f4a7">Anadolu Üniversitesi</a></li>
                    <li class="_e0485177"><a href="#" class="_c288f4a7">Koç Holding</a></li>
                  </ul>
              </li>
            </ul>
          </div>
