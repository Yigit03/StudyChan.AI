...
<html lang="tr">
  <head>
    ...
    <title> Studychan.AI | Profil</title>
    <link rel="stylesheet" type="text/css" href="/sat_4/Style_Files/style5.css">
          ...
          <div class="_157dc3d3">
            <nav id="kqqdzrxru9" class="_e45b5504 um-nav-wrapper um-classic">
              ...
              <div class="um-nav-buttons">
                ...
                <a href="tr_profile.php" id="f2t9ofnrkyg" class="btn primary">
            ...
            <div id="kqqdzrxru9-drawer" class="_e45b5504 um-nav-drawer um-hidden">
              ...
              <div class="um-drawer-buttons">
                ...
                <a href="tr_profile.php" id="d_f2t9ofnrkyg" class="btn primary">
                  <img class="um-icon _488bdcb8" src="./studychanaiv2_files/et6nkzsq7uf3q8zc.svg" alt="users.svg" style="position:relative;width:24px;height:24px;display:block;object-fit:contain">
                  <span>Profil</span>
                  <svg width="1em" viewBox="0 0 15 12" xmlns="http://www.w3.org/2000/svg" class="um-arrow">
                    <path d="M9.6 7H1a1 1 0 1 1 0-2h8.6L7 2.4A1 1 0 0 1 8.4 1l4.3 4.2c.2.3.3.5.3.8 0 .3-.1.5-.3.7L8.4 11A1 1 0 1 1 7 9.5L9.6 7z" fill="currentColor"></path>
...
<section>
<div class="wr"><br><br><br><br>
<h2 class="_b1c530f1"><span class="um-gradient-text" style="--from:#5C258D;--to:#4389A2;--angle:45deg; font-size: 40px;">Profiline hoşgeldin,<?php echo $name ;?>.</span></h2><br>
<span class="um-gradient-text" style="--from:#3B4371;--to:#F3904F;--angle:45deg; font-size: 20px;"> Burada Admin ve Moderatörlerimizin seni tanıması için hakkında bir kaç şey yazabilir veya Profil bilgilerini güncelleyebilirsin. </span>
    <div class="profil_container" ><!--Profil Bilgilerini Kapsayan Container-->
        <div class="profil_left"><!--Kullanıcının En Güncel Bilgilerini kapsayan Container-->
            <form action="/sat_4/Back_End_Files/profilupdate.php" method="post"> 
              <div class="profile_pic" style="background-color:pink;"><i class="fa-solid fa-user" style="margin-left: 10px; font-size:200px;"></i></div>
              <div class="profile_name"> <span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg; font-size: 40px;"><?php echo $name ;?></span><br><br></div>
              <input type="text" class="profile_name_input" name="username" placeholder="<-Yeni Kullanıcı Adı->">
              
              <div class="profile_email"><span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg; font-size: 14px;"><?php echo $email ;?></span></div>
              <input type="text" class="profile_email_input" name="new_email" placeholder="<- Yeni Email Adresiniz ->">

              <input type="text" class="profile_oldpass_input" name="last_pass" placeholder="<- Eski Şifreniz ->">
              <input type="text" class="profile_newpass_input" name="new_pass" placeholder="<- Yeni Şifreniz ->">

              <div class="profile_usertype"><span class="um-gradient-text" style="--from:#3a6186;--to:#89253e;--angle:45deg; font-size: 25px;"><?php echo $usertype ;?></span></div>
              <div class="profile_datetime"><?php echo $_log_date?> - Tarihinden beri üye.</div>


              
              <button type="submit" name="updateconfirm" value="Güncellemeyi Onayla" class="profile_updateconfirm_btn">Bilgilerimi Güncelle</button>
              <input type="button" name="update" value="Bilgilerimi Güncelle" class="profile_update_btn">
             
              
              <a type="submit" name="logout" class="profile_logout_btn" href="/sat_4/Back_End_Files/logout.php"> Çıkış Yap</a>
            
          </div>  

        <div class="profil_right">
          <h2 class="_b1c530f1"><span class="um-gradient-text" style="margin-left:20px; --from:#5C258D;--to:#4389A2;--angle:45deg;">Bize kendinden bahset ;</span></h2><br>
            <span class="um-gradient-text" style="margin-left:20px; --from:#3B4371;--to:#F3904F;--angle:45deg; font-size: 15px;"> Kendinden bahsederken, ilgilendiğin programlama dillerinden bahsetmeyi unutma! :)</span>
              
            
                <textarea class="profile_aboutme" name="new_hakkinda"><?php echo $hakkinda ;?></textarea>
                <button type="submit" name="aboutconfirm" value="Bilgilerimi Kaydet" class="profile_aboutme_confirm_btn">Bilgilerimi Kaydet
              </form>
...
<script>
    document.querySelector('.profile_update_btn').addEventListener('click', function() {
        document.querySelector('.profile_name').style.display = 'none';
        document.querySelector('.profile_email').style.display = 'none';
        document.querySelector('.profile_update_btn').style.display = 'none';

        document.querySelector('.profile_name_input').style.display = 'block';
        document.querySelector('.profile_email_input').style.display = 'block';
        document.querySelector('.profile_oldpass_input').style.display = 'block';
        document.querySelector('.profile_newpass_input').style.display = 'block';
        document.querySelector('.profile_updateconfirm_btn').style.display = 'block';
    });

    document.querySelector('.profile_logout_btn').addEventListener('click', function() {
        document.querySelector('.profile_name').style.display = 'block';
        document.querySelector('.profile_email').style.display = 'block';
        document.querySelector('.profile_update_btn').style.display = 'block';

        document.querySelector('.profile_name_input').style.display = 'none';
        document.querySelector('.profile_email_input').style.display = 'none';
        document.querySelector('.profile_oldpass_input').style.display = 'none';
        document.querySelector('.profile_newpass_input').style.display = 'none';
        document.querySelector('.profile_logout_btn').style.display = 'block';
        document.querySelector('.profile_updateconfirm_btn').style.display = 'none';
